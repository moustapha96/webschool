...
@section('main')
    ...
    <section class="container">
        <div class="logo text-center ">
            <h1>
                <img src="{{ asset('images/settings/ws_bj.jpg') }}" alt="App'School" height="150px" width="500px">
            </h1>
                ...
                <div id="message" class="col-md-12 col-sm-12">
                    ...
                    @if (Session::has('error'))
                        <div class="alert alert-danger">
                            <div id="msgSubmit" class="h3 text-center hidden"> Demande non envoyé , Veuillez réessayer svp
                            </div>
