                ...
                <div class="card-body">
                    <div>
                        <div class="form-group">
                            <form action="{{ route('supervisor.filiere.add') }}" method="post">
                                @csrf
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            ...
                            <div class="btn-group">
                                ...
                                <a href="{{ route('supervisor.filiere.delete', $filiere) }}"
                        ...
                        <div class="collapse" id="contentId--{{ $filiere->id }}">
                            ...
                            <div class="form-group">
                                <form action="{{ route('supervisor.filiere.update', $filiere) }}" method="post">
                                    @csrf

                                    <div class="form-group">
                                        <label for="session">code</label>
                                        <input type="text" value="{{ $filiere->code }}" class="form-control" name="code"
                                    ...
                                    <div class="form-group">
                                        <label for="session">filiere</label>
                                        <input type="text" value="{{ $filiere->name }}" class="form-control" name="name"
