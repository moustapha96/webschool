                        ...
                        <form  action="{{ route('supervisor.students.update', $student->id) }}" method="post">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    id="dateNaissance" required  value="{{ $student->user->dateNaissance }}" >
                                    @error('dateNaissance')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    id="lieuNaissance" required value="{{ $student->user->lieuNaissance }}">
                                    @error('lieuNaissance')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    id="adresse" name="adresse" value="{{ $student->user->adresse }}" required >
                                    @error('adresse')
                                        <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    id="tel" name="tel" value="{{ $student->user->tel }}" required >
                                ...
                                <div class="form-group col-md-6">
                                    <label for="genre">{{ __('genre') }} </label>
                                        <select id="genre" name="genre"  class="form-control" required >
                                            <option></option>
                                            <option value="Masculin" {{ $student->user->genre == 'Masculin'? 'selected' :'' }} >Masculin</option>
                                            <option value="Féminin" {{ $student->user->genre == 'Féminin' ? 'selected' :'' }} >Féminin</option>
                                        </select>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    id="ine"  name="ine" value="{{ $student->ine }}">
                                    ...
                                    <label for="class_id">{{ __('Classe') }} </label>
                                        <select id="class_id" name="class_id"  class="form-control" required >
                                            ...
                                            @foreach($classes as $classe)
                                              <option value="{{ $classe->id }}" {{ $classe->id == $student->class_id ? 'selected':'' }} >{{ $classe->nameClass }}</option>
                                            @endforeach
                                        </select>
                                </div>
