...
@section('main')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-window-maximize" aria-hidden="true"></i>Liste des Unités d'enseignement</h1>
                <h4 class="mt-2">Unités {{ $semestre->code }} de la {{ $semestre->classe->nameClass }}</h4>
            </div>
