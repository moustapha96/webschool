            ...
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        ...
                        <form class="form-group" action="{{ route('classes1.update1', $classe->id) }}" method="POST">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="nameClass"
                                    class="form-control  @error('nameClass') is-invalid @enderror" id="code"
                                    placeholder="code de la classe" value="{{ $classe->nameClass }}" required>
                                @error('nameClass')
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="code" class="form-control  @error('code') is-invalid @enderror"
                                    id="code" placeholder="code de la classe" value="{{ $classe->code }}" required>
                                @error('code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
