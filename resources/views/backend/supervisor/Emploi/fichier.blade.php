...
<body>
  ...
  <div class="align-content-center">
    <h1 style=" text-align: center;"> Emploi du temps {{ $code }}</h1>
    <div class="mx-auto " >
      <table style="border:1px solid #000; padding: 6px;">
        <thead class="thead-dark">
          <tr>
            ...
            <th  scope="col" style="border:1px solid #000">PROFESSEUR</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td  scope="col"style="border:1px solid #000" >{{ $class_routine->teacher->user->prenom}} {{ $class_routine->teacher->user->nom}}  </td>
            <td  scope="col"style="border:1px solid #000" >{{ $class_routine->classroom->description }}  </td>
