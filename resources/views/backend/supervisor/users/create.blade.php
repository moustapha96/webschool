    ...
    <form  method="POST" action="{{ route('admin.users.store') }}" >
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                id="prenom" placeholder="Prénom"   required value="{{ old('prenom') }}">
                @error('prenom')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                id="dateNaissance" required value="{{ old('dateNaissance') }}">
                @error('dateNaissance')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-md-6">
                ...
                id="lieuNaissance" required placeholder="Lieu de naissance" value="{{ old('lieuNaissance') }}">
                @error('lieuNaissance')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                id="adresse" name="adresse"  required placeholder="Adresse" value="{{ old('adresse') }}">
                @error('adresse')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-md-6">
                ...
                id="tel" name="tel"  required placeholder="N° de téléphone" value="{{ old('tel') }}">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                id="email" placeholder="exemple@webschool.com" name="email" value="{{ old('email') }}">
