                    ...
                    <div class="card-header">
                        <div class="card-title-wrap bar-success">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('supervisor.schedule.create') }}" class="btn btn-info float-right btn-sm"
                                        ...
                                        <tr>
                                            ...
                                            <td scope="col">
                                                <a class="btn btn-primary"
                                                    href="{{ route('supervisor.schedule.edit', $class_routine) }}"
                                                    role="button">Modifier</a>
                                                <a class="btn btn-danger"
                                                    href="{{ route('supervisor.schedule.destroy', $class_routine) }}"
