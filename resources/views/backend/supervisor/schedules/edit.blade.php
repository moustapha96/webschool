                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title-wrap bar-success">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('supervisor.schedule.index') }}" class="btn btn-info float-right btn-sm"
                    ...
                    <div class="card-body collapse show">
                        <div class="card-block card-dashboard">
                            <form class="form-group" action="{{ route('supervisor.schedule.update', $class_routine) }}"
                                method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="time" name="start_time"
                                            ...
                                            placeholder="début du cours de la salle"
