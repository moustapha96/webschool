            ...
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        ...
                        <form class="form-group" action="{{ route('classroom.update', $classroom->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror"
                                        id="code" placeholder="code de la salle" value="{{ $classroom->name }}" required>
                                    @error('salle')
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="description"
                                        ...
                                        placeholder="description de la salle" value="{{ $classroom->description }}"
                                        required>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
