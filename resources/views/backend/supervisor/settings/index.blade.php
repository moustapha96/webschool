                                            ...
                                            <ul class="nav nav-tabs nav-left">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="baseVerticalLeft2-tab1" data-toggle="tab"
                                                        aria-controls="tabVerticalLeft21" href="#tabVerticalLeft21"
                                            ...
                                            <div class="tab-content px-1">
                                                <div role="tabpanel" class="tab-pane active" id="tabVerticalLeft21"
                                                    ...
                                                    <form method="post" class="needs-validation" novalidate
                                                        autocomplete="off" action="{{ route('admin.settings.update') }}"
                                                        enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        <div class="form-row">
                                                            <div class="col-md-5">
                                                                <div class="position-relative form-group"><label
                                                                        for="school_name" class="">Nom de
                                                                        l'établissement</label><input name="school_name"
                                                                        id="school_name"
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group"><label
                                                                        for="phone1" class="">N° de téléphone
                                                                        (1)</label><input name="phone1" id="phone1"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group"><label
                                                                        for="phone2" class="">N° de téléphone
                                                                        (2)</label><input name="phone2" id="phone2"
                                                                        type="tel" class="form-control" required=""
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group"><label
                                                                        for="timezone" class="">Fuseau horaire</label>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="position-relative form-group"><label
                                                                        for="language" class="">Langue</label>
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Nom de l\'application' }}</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Titre de l\'application' }}</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Site Web' }}</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Slogan de l\'application' }}</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="jscolor form-control"
                                                                        required="" autocomplete="off" name="sidebarbgcolor"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Couleur de l\'entête' }}</label>
                                                                    <input type="text" class="form-control jscolor"
                                                                        autocomplete="off" name="headerbgcolor"
                                                                        value="{{ get_setting('headerbgcolor') }}"
                                                                        required="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <form method="post" class="needs-validation" novalidate
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Email d\'envoi' }}</label>
                                                                    <input type="text" class="form-control"
                                                                        name="from_email"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Nom d\'envoi' }}</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'SMTP Host' }}</label>
                                                                    <input type="text" class="form-control" required=""
                                                                        name="smtp_host"
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'SMTP Port' }}</label>
                                                                    <input type="text" class="form-control" required=""
                                                                        name="smtp_port"
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'SMTP Encryption' }}</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Nom d\'utilisateur SMTP' }}</label>
                                                                    <input type="text" class="form-control" required=""
                                                                        autocomplete="off" name="smtp_username"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        class="control-label">{{ 'Mot de passe SMTP' }}</label>
                                                                    <input type="password" class="form-control smtp"
                                                                        autocomplete="off" name="smtp_password"
                                                ...
                                                <div class="tab-pane" id="tabVerticalLeft24"
                                                    ...
                                                    <form method="post" class="needs-validation" novalidate
                                                        action="{{ route('settings.update_logo') }}"
                                                        enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        <div class="form-row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <label for="logo" class="btn text-center"
                                                                    ...
                                                                    <img id="logosite" src="@if (file_exists(get_setting('logo'))) {{ asset(get_setting('logo')) }} @else {{ asset('images/settings/logo.png') }} @endif" height="210px"
                                                                        width="100%"><br> {{ __('Logo') }}
                                                                </label>
                                                                <input type="file" id="logo" name="logo"
                                                                    style="visibility: hidden;"
                                                                    onchange="load_image(this, 'logosite');"
                                                                    accept=".jpg,.jpeg,.png">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="file" id="favicon" name="favicon"
                                                                    style="visibility: hidden;"
                                                                    onchange="load_image(this, 'faviconsite');"
                                                                    accept=".jpg,.jpeg,.png">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="file" id="default_avatar" name="default_avatar"
                                                                    style="visibility: hidden;"
                                                                    onchange="load_image(this, 'avatar');"
                                                                    accept=".jpg,.jpeg,.png">
                                                            </div>
