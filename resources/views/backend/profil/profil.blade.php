            ...
            <form method="post" class="needs-validation" novalidate action="{{ route('user.update_profil') }}"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" id="logo" name="logo" style="visibility: hidden;border-radius: 50% "
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            placeholder="ex@example.com" name="email" value="{{ $user->email }}">
                    ...
                    <div class="form-group col-md-6">
                        @if ($user->role === 'accountant')
                            ...
                            <input disabled type="text" name="matricule"
                                ...
                                placeholder="D232212" required value="{{ $user->accountant->matricule }}">

                        @elseif($user->role === "librian" )
                            <label for="matricule">{{ __('Matricule') }}</label>
                            <input disabled type="text" name="matricule"
                                class="form-control @error('matricule') is-invalid @enderror" id="matricule"
                                placeholder="D232212" required value="{{ $user->librian->matricule }}">

                        @elseif($user->role === "supervisor" )
                            <label for="matricule">{{ __('Matricule') }}</label>
                            <input disabled type="text" name="matricule"
                                class="form-control @error('matricule') is-invalid @enderror" id="matricule"
                                placeholder="D232212" required value="{{ $user->supervisor->matricule }}">
