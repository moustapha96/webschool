...
@section('data')
    <div class="card-block card-dashboard">
        <form class="form-group" action="{{ route('admin.unity.update', $unitie) }}" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="code" value="{{ $unitie->code }}"
                        class="form-control  @error('code') is-invalid @enderror" id="code" placeholder="code de l'unité "
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="name" value="{{ $unitie->name }}"
                        class="form-control  @error('name') is-invalid @enderror" id="name" placeholder="Nom de l'unité "
                        required>
                    @error('name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
