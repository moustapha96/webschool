                                ...
                                <div class="tab-content px-1">
                                    <div role="tabpanel" class="tab-pane active" id="tabVerticalLeft21" aria-expanded="true"
                                        ...
                                        <form method="post" class="needs-validation" novalidate autocomplete="off"
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-5">
                                                    <div class="position-relative form-group"><label for="school_name"
                                                            ...
                                                            id="school_name" placeholder="Nom de l'étanlissement"
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="phone1"
                                                            class="">N° de téléphone
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="phone2"
                                                            class="">N° de téléphone
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="status"
                                                        ...
                                                        <select class="form-control select2" id="status" type=""
                                                            ...
                                                            <option value="privé"   {{ get_setting('status') == "privé" ? 'selected' : '' }}  >Privé</option>
                                                            <option value="pubic"  {{ get_setting('status') == "public" ? 'selected' : '' }}  >Public</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" required=""
                                                            name="app_slogan" value="{{ get_setting('app_slogan') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control jscolor" autocomplete="off"
                                                            name="headerbgcolor"
                                                            value="{{ get_setting('headerbgcolor') }}" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
