              ...
              <div class=" row ">
                  <div class="col-md-6 ">
                    <div class="flex-lg-row ml"> <u> Prénom et Nom </u>: <strong class="text-uppercase" > {{ $student_file->student->user->prenom }} {{ $student_file->student->user->nom }}</strong>  </div>
                      ...
                      <div class="flex-lg-row ml"> <u>Classe </u>: <strong class="text-uppercase" >
                          {{ $student_file->bulletin->classe->niveau->code .' ' . $student_file->bulletin->classe->filiere->code }}</strong>  </div>
                  </div>
