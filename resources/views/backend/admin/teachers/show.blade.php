                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-8">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->user->prenom }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->user->nom }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="adresse" class="col-sm-3 col-form-label">Adresse</label>
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->user->adresse }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->user->tel }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="genre" class="col-sm-3 col-form-label">Genre</label>
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->user->genre }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="matricule" class="col-sm-3 col-form-label">Matricule</label>
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->matricule }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-sm-3 col-form-label">Email</label>
                            <div class="col-sm-5">
                                <input disabled type="text" class="form-control" value="{{ $teacher->user->email }}">
                            </div>
                        </div>
