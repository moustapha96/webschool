                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a class="btn btn-outline-primary float-right"
                                        href="{{ route('admin.user.index') }}"><i class="fa fa-users"></i>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="lieuNaissance"
                                            ...
                                            id="lieuNaissance" required placeholder="Lieu de naissance"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('adresse') is-invalid @enderror"
                                            id="adresse" name="adresse" required placeholder="Adresse"
                                            value="{{ old('adresse') }}">
                                        @error('adresse')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('tel') is-invalid @enderror" id="tel"
                                            name="tel" required placeholder="N° de téléphone" value="{{ old('tel') }}">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror"
                                            id="email" placeholder="exemple@webschool.com" name="email"
                                            value="{{ old('email') }}">
