...
@endsection
@section('option')
    <a class="btn btn-outline-success nav-link" data-toggle="tab" href="#message_nouveau">
                                        ...
                                        <tbody>
                                            @foreach (auth()->user()->unreadNotifications as $noti)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('notificationsLibrian.update', $noti) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('POST')
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <form
                                                                    action="{{ route('messagesLibrian.store') }}"
                        ...
                        <div class="tab-pane fade mt-4" id="message_nouveau">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer text-muted">
                                        <form action="{{ route('messagesLibrian.store') }}" method="post"
