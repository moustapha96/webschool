                        ...
                        <div>
                            <form  method="POST" action="{{ route('librian.book_issu.update',$book_issu) }}" >
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    id="prenom" value="{{ $book_issu->student->ine }}-{{ $book_issu->student->user->prenom }}-{{ $book_issu->student->user->nom }}">

                                </div>
                                <div class="form-group col-md-12">
                                    <label for="livre">{{ __('Livre') }}</label>
                                    <input  disabled type="text"  class="form-control" 
                                    id="prenom" value="{{ $book_issu->book->name }}">
                                    
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="issue_date">{{ __('Date emprunt') }}</label>
                                    <input type="date" format="YYYY-MM-DD" value="{{ $book_issu->issue_date }}" name="issue_date" class="form-control  @error('issue_date') is-invalid @enderror" 
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    id="due_date"  value="{{ $book_issu->due_date }}" required >
                                        @error('due_date')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    id="return_date" value="{{ $book_issu->return_date }}"  required >
                                        @error('return_date')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    id="comment" value="{{ $book_issu->comment }}" placeholder="commentaire du livre"  required >
                                        @error('comment')
                                            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                            </span>
