                                    ...
                                    <div class="tile">
                                        <div class="tile-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input  disabled type="text"  class="form-control" 
                                                    id="quatite" value="{{ $book->categorie->name }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tile">
                                        <div class="tile-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input  disabled type="text"  class="form-control" 
                                                    id="Categorie" value="{{ $book_issu->issue_date }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input  disabled type="text"  class="form-control" 
                                                    id="Categorie" value="{{ $book_issu->due_date  }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input  disabled type="text"  class="form-control" 
                                                    id="Categorie" value="{{ $book_issu->return_date }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input  disabled type="text"  class="form-control" 
                                                    id="Categorie" value="{{ $book_issu->comment }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    <input  disabled type="text"  class="form-control" 
                                                    id="Categorie" value="{{ $book_issu->status }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
