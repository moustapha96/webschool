                                    ...
                                    <tbody>
                                        @foreach (auth()->user()->unreadNotifications as $noti)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('notificationsTeacher.update', $noti) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('POST')
                                            ...
                                            <td>
                                                <div class="accordion" id="accordionExample">
                                                    <div class="card">
                                                        ...
                                                        <div id="collapse-{{ $notification->id }}" class="collapse show"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <form action="{{ route('messagesTeacher.store') }}"
                    ...
                    <div class="tab-pane fade mt-4" id="message_nouveau">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-footer text-muted">
                                    <form action="{{ route('messagesTeacher.store') }}" method="post"
